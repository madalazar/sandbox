...
import "github.com/margo/sandbox/poc/device/agent/resource"
...
type CPUPlanningRequest struct {
	Requirements resource.NormalizedCPURequirements
...
type CPUPlanner interface {
	PlanCPU(CPUPlanningRequest) (resource.CpuPlan, error)
}
